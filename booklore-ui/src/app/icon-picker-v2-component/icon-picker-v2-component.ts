...
@Component({
  selector: 'app-icon-picker-v2-component',
  imports: [
    FormsModule
  ],
  templateUrl: './icon-picker-v2-component.html',
  styleUrl: './icon-picker-v2-component.scss'
})
export class IconPickerV2Component {
