...
export enum TaskType {
  ...
  DIRECTORY_TAGGING = 'DIRECTORY_TAGGING',
...
export const TASK_TYPE_CONFIG: Record<TaskType, { parallel: boolean; async: boolean; displayOrder: number }> = {
  ...
  [TaskType.DIRECTORY_TAGGING]: {parallel: false, async: true, displayOrder: 3},
  [TaskType.BOOKDROP_PERIODIC_SCANNING]: {parallel: false, async: false, displayOrder: 4},
