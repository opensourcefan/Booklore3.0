...
- **Theme Color Customizer** — Pick preset Primary and Surface colors from the topbar theme popover or jump straight into the custom picker from a `+` trigger; once custom mode is used, each section keeps recent colors inline for quick reuse.
