- After pushing, provide a numbered fix summary matching the user’s task order IN THE EDITOR WINDOW, not the chat window.
...
- Work from actual evidence only 
- Avoid assumptions
- "identifing likely causes" means you are not sure, that is Guesswork.
- Reverse engineer task-related code when possible.
