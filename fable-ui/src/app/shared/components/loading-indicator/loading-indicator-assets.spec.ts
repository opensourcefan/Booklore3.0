...
describe('Loading indicator asset mapping', () => {
  ...
  it('delays loader reveal and darkens inline loaders on all filled buttons', () => {
    const styles = readWorkspaceFile('src/styles.scss');
    ...
    expect(styles).toContain('.p-button:not(.p-button-outlined):not(.p-button-text):not(.p-button-link) {');
