...
def _generate_answer(query: str, context: str, max_tokens: int, temperature: float, chat_history: list[dict] = None) -> str:
    ...
    system_prompt = (
        ...
        "- If the user asks for 'list', 'bullet points', 'sequence', or 'steps': "
        "provide the answer as a structured, clean list using bullet points or numbered items where appropriate.\n"
