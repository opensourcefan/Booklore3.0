...
class FableSchemaTest {

    private XMPMetadata xmpMetadata;
    private FableSchema schema;

    @BeforeEach
    void setUp() {
        xmpMetadata = XMPMetadata.createXMPMetadata();
        schema = new FableSchema(xmpMetadata);
    }
    ...
    class ScalarTextPropertiesTests {
        ...
        void setSubtitle_addsPropertyToSchema() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.SUBTITLE);
        ...
        void setSubtitle_whenBlank_doesNotAddProperty() {
            ...
            assertNull(schema.getProperty(FableSchema.SUBTITLE));
        }
        ...
        void setIsbn10_addsPropertyToSchema() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.ISBN_10);
            assertNotNull(property);
        ...
        void setLubimyczytacId_addsPropertyToSchema() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.LUBIMYCZYTAC_ID);
            assertNotNull(property);
        ...
        void setHardcoverBookId_addsPropertyToSchema() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.HARDCOVER_BOOK_ID);
            assertNotNull(property);
    ...
    class RatingPropertiesTests {
        ...
        void setRating_formatsWithLocaleUS() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.RATING);
            assertNotNull(property);
        ...
        void setAmazonRating_formatsCorrectly() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.AMAZON_RATING);
            assertNotNull(property);
        ...
        void setGoodreadsRating_formatsCorrectly() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.GOODREADS_RATING);
            assertNotNull(property);
        ...
        void setRating_whenNull_doesNotAddProperty() {
            ...
            assertNull(schema.getProperty(FableSchema.RATING));
        }
    }
    ...
    class TextCollectionPropertiesTests {
        ...
        void setMoods_createsDelimitedText() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.MOODS);
            assertNotNull(property);
        ...
        void setMoods_whenEmpty_doesNotAddProperty() {
            ...
            assertNull(schema.getProperty(FableSchema.MOODS));
        }
        ...
        void setTags_createsDelimitedText() {
            ...
            TextType property = (TextType) schema.getProperty(FableSchema.TAGS);
            assertNotNull(property);
            String value = property.getStringValue();
    ...
    class NamespaceTests {
        ...
        void namespace_isCorrect() {
            assertEquals("http://fable.org/metadata/1.0/", FableSchema.NAMESPACE);
        }

        @Test
        void prefix_isCorrect() {
            assertEquals("fable", FableSchema.PREFIX);
        }
    }
}
