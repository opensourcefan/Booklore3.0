...
import org.fable.model.dto.AuthorDetails;
import org.fable.model.dto.AuthorSearchResult;
import org.fable.model.dto.FableUser;
import org.fable.model.dto.request.AuthorMatchRequest;
...
import org.fable.service.metadata.DuckDuckGoCoverService;
import org.fable.service.metadata.parser.AuthorParser;
...
class AuthorMetadataServiceTest {
    ...
    void setUp() {
        ...
        FableUser.UserPermissions adminPermissions = new FableUser.UserPermissions();
        adminPermissions.setAdmin(true);
        FableUser adminUser = FableUser.builder().id(1L).permissions(adminPermissions).build();
