...
import org.fable.mapper.BookMarkMapper;
import org.fable.model.dto.FableUser;
import org.fable.model.dto.BookMark;
import org.fable.model.dto.CreateBookMarkRequest;
...
import org.fable.repository.BookMarkRepository;
...
class BookMarkServiceTest {
    ...
    @BeforeEach
    void setUp() {
        userDto = FableUser.builder().id(userId).isDefaultPassword(false).build();
        userEntity = FableUserEntity.builder().id(userId).isDefaultPassword(false).build();
