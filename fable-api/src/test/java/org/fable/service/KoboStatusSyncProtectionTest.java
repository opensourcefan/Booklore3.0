...
import org.fable.mapper.KoboReadingStateMapper;
import org.fable.model.dto.FableUser;
import org.fable.model.dto.KoboSyncSettings;
import org.fable.model.dto.kobo.KoboReadingState;
import org.fable.model.entity.BookEntity;
import org.fable.model.entity.FableUserEntity;
import org.fable.model.entity.KoboReadingStateEntity;
...
import org.fable.repository.KoboReadingStateRepository;
...
import org.fable.service.kobo.KoboReadingStateBuilder;
import org.fable.service.kobo.KoboReadingStateService;
import org.fable.service.kobo.KoboSettingsService;
...
class KoboStatusSyncProtectionTest {
    ...
    private FableUserEntity testUserEntity;
    private KoboSyncSettings testSettings;

    @BeforeEach
    void setUp() {
        testUser = FableUser.builder().id(1L).username("testuser").isDefaultPassword(false).build();
        testUserEntity = new FableUserEntity();
    ...
    @Nested
    @DisplayName("Pending Sync Protection - User changed status in Fable, waiting to sync to Kobo")
    class PendingSyncProtection {

        @Test
        @DisplayName("User marks book READ in Fable -> Kobo sends 50% progress before sync completes -> READ status preserved until synced")
        ...
        @Test
        @DisplayName("User marks book UNREAD in Fable -> Kobo sends 100% progress before sync -> UNREAD preserved until synced")
