...
import org.fable.service.metadata.BookCoverService;
...
class BookFileDetachmentServiceTest {
    ...
    void detachAlternativeFormat_withCopyMetadata() {
        ...
        verify(auditService).log(eq(org.fable.model.enums.AuditAction.BOOK_FILE_DETACHED), anyString(), eq(1L), anyString());
