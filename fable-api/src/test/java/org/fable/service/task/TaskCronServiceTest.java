...
import org.fable.model.dto.request.TaskCronConfigRequest;
import org.fable.model.dto.response.CronConfig;
import org.fable.model.entity.TaskCronConfigurationEntity;
import org.fable.model.enums.TaskType;
import org.fable.repository.TaskCronConfigurationRepository;
...
class TaskCronServiceTest {
    ...
    void testPatchCronConfig_updateExisting() {
        TaskType type = TaskType.CLEANUP_DELETED_BOOKS;
        FableUser user = FableUser.builder().id(10L).isDefaultPassword(false).build();
