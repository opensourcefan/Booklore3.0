...
/**
 * Verifies that BookLoreUserEntity and LibraryEntity use LAZY fetching
 ...
 */
class BookLoreUserEntityFetchTypeTest {

    @Test
    @DisplayName("BookLoreUserEntity.libraries must be LAZY (was EAGER before fix #1)")
    void userLibrariesShouldBeLazy() throws NoSuchFieldException {
        Field librariesField = BookLoreUserEntity.class.getDeclaredField("libraries");
    ...
    @Test
    @DisplayName("BookLoreUserEntity.settings must be LAZY (was EAGER before fix #1)")
    void userSettingsShouldBeLazy() throws NoSuchFieldException {
        Field settingsField = BookLoreUserEntity.class.getDeclaredField("settings");
