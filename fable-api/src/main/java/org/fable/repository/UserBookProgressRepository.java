...
import org.fable.model.dto.BookCompletionHeatmapDto;
import org.fable.model.dto.CompletionTimelineDto;
import org.fable.model.dto.ProgressPercentDto;
import org.fable.model.dto.RatingDistributionDto;
import org.fable.model.dto.StatusDistributionDto;
...
public interface UserBookProgressRepository extends JpaRepository<UserBookProgressEntity, Long> {
    ...
    @Query("""
            ...
            AND ubp.readStatus NOT IN (org.fable.model.enums.ReadStatus.UNSET, org.fable.model.enums.ReadStatus.UNREAD)
    ...
    int bulkUpdateReadStatus(
            ...
            @Param("readStatus") org.fable.model.enums.ReadStatus readStatus,
    ...
    @Query("""
        ...
        WHERE ubp.user.id = :userId
          AND ubp.book.id IN :bookIds
    """)
    int bulkResetFableProgress(@Param("userId") Long userId, @Param("bookIds") List<Long> bookIds, @Param("modifiedTime") java.time.Instant modifiedTime);
    ...
    @Query("""
            ...
            WHERE ubp.user.id = :userId
            AND ubp.readStatus IS NOT NULL
            AND ubp.readStatus <> org.fable.model.enums.ReadStatus.UNSET
