...
public class UserController {
    ...
    @GetMapping("/me")
    public ResponseEntity<FableUser> getMyself() {
    ...
    public ResponseEntity<FableUser> getUser(@Parameter(description = "ID of the user") @PathVariable Long id) {
        return ResponseEntity.ok(userService.getFableUser(id));
    }
    ...
    public ResponseEntity<List<FableUser>> getAllUsers() {
        return ResponseEntity.ok(userService.getFableUsers());
    }

    @Operation(summary = "Update user", description = "Update a user's profile by their ID. Admins may update any user; users may update their own username/name/email.")
    ...
    public ResponseEntity<FableUser> updateUser(
        ...
        FableUser updatedUser = userService.updateUser(id, updateRequest);
