...
import org.fable.service.ShelfService;
import org.fable.service.book.BookDownloadService;
import org.fable.service.book.BookService;
import org.fable.service.kobo.*;
...
public class KoboController {
    ...
    public ResponseEntity<?> syncLibrary(@AuthenticationPrincipal FableUser user) {
