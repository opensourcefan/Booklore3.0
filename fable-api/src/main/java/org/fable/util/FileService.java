...
import org.fable.model.dto.settings.CoverCroppingSettings;
...
public class FileService {
    ...
    private BufferedImage downloadImageFromUrlInternal(String imageUrl) throws IOException {
        ...
        while (redirectCount <= MAX_REDIRECTS) {
            ...
            headers.set(HttpHeaders.USER_AGENT, "Fable/1.0 (Book and Comic Metadata Fetcher; +https://github.com/fable-app/fable)");
