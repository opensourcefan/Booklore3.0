package org.fable.service.oidc;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.fable.exception.ApiError;
import org.fable.mapper.OidcGroupMappingMapper;
import org.fable.model.dto.OidcGroupMapping;
...
import org.fable.repository.OidcGroupMappingRepository;
...
public class OidcGroupMappingService {
    ...
    @Transactional
    public void syncUserGroups(FableUserEntity user, List<String> groups) {
    ...
    private void applyPermissions(UserPermissionsEntity perms, Set<String> permissions, boolean isAdmin, boolean additive) {
        if (!additive) {
            ...
            perms.setPermissionBulkResetFableReadProgress(permissions.contains("permissionBulkResetFableReadProgress"));
            ...
            if (permissions.contains("permissionBulkResetFableReadProgress")) perms.setPermissionBulkResetFableReadProgress(true);
