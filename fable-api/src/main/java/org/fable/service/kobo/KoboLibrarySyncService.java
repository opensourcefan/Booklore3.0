...
public class KoboLibrarySyncService {
    ...
    private final FableSyncTokenGenerator tokenGenerator;
    ...
    @Transactional
    public ResponseEntity<?> syncLibrary(FableUser user, String token) {
        HttpServletRequest request = RequestUtils.getCurrentRequest();
        FableSyncToken syncToken = Optional.ofNullable(tokenGenerator.fromRequestHeaders(request)).orElse(new FableSyncToken());
