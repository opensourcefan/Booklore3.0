...
public class OpdsFeedService {
    ...
    public String generateRootNavigation(HttpServletRequest request) {
        ...
        String feed = """
                ...
                <feed xmlns="http://www.w3.org/2005/Atom" xmlns:opds="http://opds-spec.org/2010/catalog">
                  <id>urn:fable:root</id>
                  <title>Fable Catalog</title>
                  <updated>%s</updated>
                ...
                """
                          <entry>
                            ...
                            <id>urn:fable:catalog:recent</id>
                            <updated>%s</updated>
                            <link rel="subsection" href="%s" type="application/atom+xml;profile=opds-catalog;kind=acquisition"/>
                ...
                """
                          <entry>
                            ...
                            <id>urn:fable:navigation:libraries</id>
                            <updated>%s</updated>
                ...
                """
                          <entry>
                            <title>Shelves</title>
                            <id>urn:fable:navigation:shelves</id>
                            <updated>%s</updated>
                ...
                """
                          <entry>
                            ...
                            <id>urn:fable:navigation:magic-shelves</id>
                            <updated>%s</updated>
                ...
                """
                          <entry>
                            <title>Authors</title>
                            <id>urn:fable:navigation:authors</id>
                            <updated>%s</updated>
                ...
                """
                          <entry>
                            <title>Series</title>
                            <id>urn:fable:navigation:series</id>
                            <updated>%s</updated>
                ...
                """
                          <entry>
                            ...
                            <id>urn:fable:catalog:surprise</id>
                            <updated>%s</updated>
    ...
    public String getOpenSearchDescription() {
        return """
                ...
                <OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
                  <ShortName>Fable</ShortName>
                  <Description>Search Fable catalog</Description>
    ...
    private String determineFeedTitle(Long libraryId, Set<Long> shelfIds, Long magicShelfId, String author, String series) {
        ...
        return "Fable Catalog";
    }

    private String determineFeedId(Long libraryId, Set<Long> shelfIds, Long magicShelfId, String author, String series) {
        if (magicShelfId != null) {
            return "urn:fable:magic-shelf:" + magicShelfId;
        }
        if (shelfIds != null && !shelfIds.isEmpty()) {
            if (shelfIds.size() == 1) {
                return "urn:fable:shelf:" + shelfIds.iterator().next();
            }
            return "urn:fable:shelves:" + String.join(",", shelfIds.stream().map(String::valueOf).sorted().toList());
        }
        if (libraryId != null) {
            return "urn:fable:library:" + libraryId;
        }
        if (author != null && !author.isBlank()) {
            return "urn:fable:author:" + author;
        }
        if (series != null && !series.isBlank()) {
            return "urn:fable:series:" + series;
        }
        return "urn:fable:catalog";
    }
