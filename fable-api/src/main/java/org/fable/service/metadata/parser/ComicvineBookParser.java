...
import org.fable.model.dto.response.comicvineapi.Comic;
import org.fable.model.dto.response.comicvineapi.ComicvineApiResponse;
import org.fable.model.dto.response.comicvineapi.ComicvineIssueResponse;
    ...
    private <T> T sendRequestWithRetry(URI uri, Class<T> responseType, int retriesLeft) {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(uri)
                    .header("User-Agent", "Fable/1.0 (Book and Comic Metadata Fetcher; +https://github.com/fable-app/fable)")
                    .GET()
                    .build();
        ...
        notificationService.sendMessage(
                ...
                notificationService.sendMessage(
                    ...
                    TaskProgressPayload.builder()
                        ...
                        .taskStatus(org.fable.task.TaskStatus.IN_PROGRESS)
                        .build()
                );
    }
