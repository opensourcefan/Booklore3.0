...
public class FableSchema extends XMPSchema {

    public static final String NAMESPACE = "http://fable.org/metadata/1.0/";
    public static final String PREFIX = "fable";
    ...
    public FableSchema(XMPMetadata metadata) {
