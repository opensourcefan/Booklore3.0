                    ...
                    for (int i = 0; i < children.getLength(); i++) {
                        ...
                        switch (tag) {
                            ...
                            case "meta" -> {
                                ...
                                if (!seriesFound && ((FableMetadata.NS_PREFIX + ":series").equals(prop) || "calibre:series".equals(name) || "belongs-to-collection".equals(prop))) {
                                    builderMeta.seriesName(content);
                                    seriesFound = true;
                                }
                                if (!seriesIndexFound && ((FableMetadata.NS_PREFIX + ":series_index").equals(prop) || "calibre:series_index".equals(name) || "group-position".equals(prop))) {
                                    try {
                                ...
                                if ("calibre:pages".equals(name) || "pagecount".equals(name) || "schema:pagecount".equals(prop) || "media:pagecount".equals(prop) || (FableMetadata.NS_PREFIX + ":page_count").equals(prop)) {
                                ...
                                if (key.equals(FableMetadata.NS_PREFIX + ":asin")) builderMeta.asin(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":goodreads_id")) builderMeta.goodreadsId(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":comicvine_id")) builderMeta.comicvineId(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":ranobedb_id")) builderMeta.ranobedbId(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":hardcover_id")) builderMeta.hardcoverId(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":google_books_id")) builderMeta.googleId(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":lubimyczytac_id")) builderMeta.lubimyczytacId(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":page_count")) safeParseInt(content, builderMeta::pageCount);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":subtitle")) builderMeta.subtitle(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":series_total")) safeParseInt(content, builderMeta::seriesTotal);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":rating")) { /* Generic rating not supported */ }
                                else if (key.equals(FableMetadata.NS_PREFIX + ":amazon_rating")) safeParseDouble(content, builderMeta::amazonRating);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":amazon_review_count")) safeParseInt(content, builderMeta::amazonReviewCount);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":goodreads_rating")) safeParseDouble(content, builderMeta::goodreadsRating);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":goodreads_review_count")) safeParseInt(content, builderMeta::goodreadsReviewCount);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":hardcover_rating")) safeParseDouble(content, builderMeta::hardcoverRating);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":hardcover_review_count")) safeParseInt(content, builderMeta::hardcoverReviewCount);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":lubimyczytac_rating")) safeParseDouble(content, builderMeta::lubimyczytacRating);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":ranobedb_rating")) safeParseDouble(content, builderMeta::ranobedbRating);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":age_rating")) safeParseInt(content, v -> { if (VALID_AGE_RATINGS.contains(v)) builderMeta.ageRating(v); });
                                else if (key.equals(FableMetadata.NS_PREFIX + ":content_rating")) builderMeta.contentRating(content);
                                else if (key.equals(FableMetadata.NS_PREFIX + ":moods")) {
                                    if (StringUtils.isNotBlank(content)) {
                                        extractSetField(content, moods);
                                    }
                                }
                                else if (key.equals(FableMetadata.NS_PREFIX + ":tags")) {
                                    if (StringUtils.isNotBlank(content)) {
