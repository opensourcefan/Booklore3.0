...
import org.fable.model.dto.UserCreateRequest;
...
public class UserProvisioningService {
    ...
    public void provisionInitialUser(InitialUserRequest request) {
        ...
        perms.setPermissionBulkResetFableReadProgress(true);
    ...
    public void provisionInternalUser(UserCreateRequest request) {
        Optional<FableUserEntity> existingUser = userRepository.findByUsername(request.getUsername());
        ...
        permissions.setPermissionBulkResetFableReadProgress(request.isPermissionBulkResetFableReadProgress());
    ...
    @Transactional
    public FableUserEntity provisionOidcUser(String username, String email, String name,
     ...
     */
    @Transactional
    public FableUserEntity provisionRemoteUserFromHeaders(String name, String username, String email, String groups) {
    ...
    protected FableUserEntity createUser(FableUserEntity user) {
        FableUserEntity save = userRepository.save(user);
