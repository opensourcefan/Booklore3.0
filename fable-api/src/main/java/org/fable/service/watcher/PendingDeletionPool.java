package org.fable.service.watcher;
...
public class PendingDeletionPool {
    ...
    @Transactional
    public void recoverBook(MatchResult match, org.fable.model.entity.LibraryPathEntity newLibraryPath, String newFileSubPath, String newFileName, String hash) {
