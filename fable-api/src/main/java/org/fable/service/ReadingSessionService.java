...
import org.fable.model.dto.CompletionRaceSessionDto;
import org.fable.model.dto.request.ReadingSessionRequest;
import org.fable.model.dto.PageTurnerSessionDto;
import org.fable.model.dto.BookTimelineDto;
import org.fable.model.dto.ProgressPercentDto;
import org.fable.model.dto.ReadingSessionCountDto;
...
import org.fable.model.entity.ReadingSessionEntity;
import org.fable.model.enums.ReadStatus;
import org.fable.repository.BookRepository;
import org.fable.repository.ReadingSessionRepository;
...
public class ReadingSessionService {
    ...
    public void recordSession(ReadingSessionRequest request) {
        FableUser authenticatedUser = authenticationService.getAuthenticatedUser();
        Long userId = authenticatedUser.getId();

        FableUserEntity userEntity = userRepository.findById(userId).orElseThrow(() -> new UsernameNotFoundException("User not found with ID: " + userId));
