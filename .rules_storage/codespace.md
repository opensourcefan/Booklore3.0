...
| Latest documented tag | `v4.16.33` |
...
- ngx-extended-pdf-viewer 25.6.4 — PDF reader
...
- Backend/frontend version: `4.16.33` (in `fable-api/build.gradle` and `fable-ui/package.json`)
- Latest documented git tag: `v4.16.33`
