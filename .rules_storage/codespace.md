...
| Latest documented tag | `v4.16.39` |
...
- ngx-extended-pdf-viewer 25.6.4 — PDF reader; primary toolbar uses wide Contents/Thumbs nav, rotate beside zoom, Annotate + More labeled menus (pan/select/print/links/theme); layout modes still use ngx secondary Tools overflow on tablet
...
- Backend/frontend version: `4.16.38` (in `fable-api/build.gradle` and `fable-ui/package.json`)
- Latest documented git tag: `v4.16.39`
