---
description: "Diagnose Fable logs for concrete errors. Use when: investigating Docker container logs, Spring Boot stack traces, Angular console errors, HTTP failures, startup crashes, auth failures, or integration errors."
...
Diagnose Fable logs for concrete errors and root causes.

Context:
- Runtime topology: [docker-compose.yml](../../docker-compose.yml)
- Project overview and deployment notes: [README.md](../../README.md)
- API logging configuration: [fable-api/src/main/resources/application.yaml](../../fable-api/src/main/resources/application.yaml)
- API request logging: [fable-api/src/main/java/org/booklore/config/LoggingFilter.java](../../fable-api/src/main/java/org/booklore/config/LoggingFilter.java)
- API exception mapping: [fable-api/src/main/java/org/booklore/exception/GlobalExceptionHandler.java](../../fable-api/src/main/java/org/booklore/exception/GlobalExceptionHandler.java)
- Frontend bootstrap and top-level console surface: [fable-ui/src/main.ts](../../fable-ui/src/main.ts)
