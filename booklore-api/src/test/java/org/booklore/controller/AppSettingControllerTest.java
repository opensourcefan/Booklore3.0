...
class AppSettingControllerTest {
    ...
    void updateSettings_shouldDelegateEachSettingToService() throws Exception {
        ...
        verify(appSettingService).updateSetting(org.booklore.model.dto.settings.AppSettingKey.AUTO_BOOK_SEARCH, true);
        verify(appSettingService).updateSetting(org.booklore.model.dto.settings.AppSettingKey.MAX_FILE_UPLOAD_SIZE_IN_MB, 250);
    }
