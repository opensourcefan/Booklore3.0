...
public class EpubMetadataReader {
    ...
    public EpubMetadata readMetadata(File epubFile) {
        try (ZipFile zip = new ZipFile(epubFile)) {
            ...
            try (InputStream cis = zip.getInputStream(containerHdr)) {
                ...
                try (InputStream in = zip.getInputStream(opfHdr)) {
                    ...
                    EpubMetadata.EpubMetadataBuilder builderMeta = EpubMetadata.builder();
                    ...
                    for (int i = 0; i < children.getLength(); i++) {
                        ...
                        switch (tag) {
                            ...
                            case "meta" -> {
                                ...
                                if (name.equals("calibre:pages") || name.equals("pagecount") ||
                                        prop.equals("schema:pagecount") || prop.equals("media:pagecount") ||
                                        prop.equals("booklore:page_count")) {
                                    try {
                                ...
                                switch (prop) {
                                    ...
                                    case "booklore:amazon_rating_count" -> safeParseInt(content, builderMeta::amazonReviewCount);
                                    ...
                                    case "booklore:goodreads_rating_count" -> safeParseInt(content, builderMeta::goodreadsReviewCount);
                                    ...
                                    case "booklore:hardcover_rating_count" -> safeParseInt(content, builderMeta::hardcoverReviewCount);
