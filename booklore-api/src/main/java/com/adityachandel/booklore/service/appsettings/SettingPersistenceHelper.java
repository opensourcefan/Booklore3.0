...
public class SettingPersistenceHelper {
    ...
    MetadataRefreshOptions getDefaultMetadataRefreshOptions() {
        MetadataRefreshOptions.FieldProvider titleProviders =
                new MetadataRefreshOptions.FieldProvider(MetadataProvider.Google, MetadataProvider.GoodReads, MetadataProvider.Amazon);
        MetadataRefreshOptions.FieldProvider subtitleProviders =
                new MetadataRefreshOptions.FieldProvider(null, null, null);
        ...
        MetadataRefreshOptions.FieldProvider categoriesProviders =
                new MetadataRefreshOptions.FieldProvider(MetadataProvider.Google, MetadataProvider.Amazon, MetadataProvider.GoodReads);
