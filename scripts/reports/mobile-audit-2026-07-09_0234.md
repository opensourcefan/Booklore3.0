...
| # | File | Line | Description |
|---|------|------|-------------|
| 1 | `library-creator.component.html` | 1 | dialog template has a custom header but lacks standard 'close-button' class |
| 2 | `story-arc-book-picker.component.html` | 1 | dialog template has a custom header but lacks standard 'close-button' class |
| 3 | `story-arc-assigner.component.html` | 1 | dialog template has a custom header but lacks standard 'close-button' class |
| 4 | `directory-picker.component.html` | 1 | dialog template has a custom header but lacks standard 'close-button' class |
| 5 | `icon-picker-component.html` | 1 | dialog template has a custom header but lacks standard 'close-button' class |
