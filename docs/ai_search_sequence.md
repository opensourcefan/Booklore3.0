...
| 1.10 | State saved to `localStorage` (query, results, chat history, book scope) | [`ai-search-dialog.component.ts`](fable-ui/src/app/features/book/components/ai-search-dialog/ai-search-dialog.component.ts:574) | `✅ COMPLETED` |
...
| 15.7 | State saved to `localStorage` for persistence across dialog close/reopen | [`ai-search-dialog.component.ts`](fable-ui/src/app/features/book/components/ai-search-dialog/ai-search-dialog.component.ts:622) | `✅ COMPLETED` |
