# Podman Example
This directory contains an example of how to use a rootless Podman pod defined through Quadlets to run fable.
...
- `systemctl --user status fable-pod -l` - Check the status of the pod
- `systemctl --user status fable-db -l` - Check the status of the database
- `systemctl --user status fable -l` - Check the status of the fable container
